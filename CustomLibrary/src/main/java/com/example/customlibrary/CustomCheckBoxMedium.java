...
public class CustomCheckBoxMedium extends CheckBox {

    Context context;

    public CustomCheckBoxMedium(Context context, AttributeSet attrs, int defStyleAttr) {
        super(context, attrs, defStyleAttr);
        this.context = context;
        init(attrs);
    }

    public CustomCheckBoxMedium(Context context) {
        super(context);
        this.context = context;
        init(null);
    }

    public CustomCheckBoxMedium(Context context, AttributeSet attrs) {
        super(context, attrs);
        this.context = context;
        init(attrs);
