...
public class CustomButtonMedium extends Button {
    ...
    public void init(AttributeSet attr) {
        ...
        if (attr != null) {
            Typeface face = Typeface.createFromAsset(getContext().getAssets(), Constant.FONT_BOLD);
            ...
            switch (sizeType){
                case 0:
                    setTextSize(TypedValue.COMPLEX_UNIT_PX, getResources().getDimension(R.dimen.text_size_16));
                    break;
                case 1:
                ...
                case 2:
                    ...
                    break;
                case 3:
                    setTextSize(TypedValue.COMPLEX_UNIT_PX, getResources().getDimension(R.dimen.text_size_18));
                    break;
                case 4:
                    setTextSize(TypedValue.COMPLEX_UNIT_PX, getResources().getDimension(R.dimen.text_size_16));
                    break;
                case 5:
                    setTextSize(TypedValue.COMPLEX_UNIT_PX, getResources().getDimension(R.dimen.text_size_14));
                    break;
                case 6:
