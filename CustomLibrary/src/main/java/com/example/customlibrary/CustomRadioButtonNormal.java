...
public class CustomRadioButtonNormal extends RadioButton {

    Context context;

    public CustomRadioButtonNormal(Context context, AttributeSet attrs, int defStyleAttr) {
        super(context, attrs, defStyleAttr);
        this.context = context;
        init(attrs);
    }

    public CustomRadioButtonNormal(Context context) {
        super(context);
        this.context = context;
        init(null);
    }

    public CustomRadioButtonNormal(Context context, AttributeSet attrs) {
        super(context, attrs);
        this.context = context;
        init(attrs);
